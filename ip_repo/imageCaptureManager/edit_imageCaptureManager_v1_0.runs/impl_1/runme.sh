...
HD_PWD='E:/oms/VideoControlIP/ip_repo/imageCaptureManager/edit_imageCaptureManager_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log imageCaptureManager_v1_0.vdi -applog -m64 -messageDb vivado.pb -mode batch -source imageCaptureManager_v1_0.tcl -notrace
