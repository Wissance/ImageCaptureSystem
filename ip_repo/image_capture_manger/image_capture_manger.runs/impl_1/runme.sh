...
HD_PWD='E:/oms/VideoControlIP/ip_repo/image_capture_manger/image_capture_manger.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log image_capture_manager_v1_0.vdi -applog -m64 -messageDb vivado.pb -mode batch -source image_capture_manager_v1_0.tcl -notrace
