...
HD_PWD='E:/oms/VideoControlIP/ip_repo/image_capture_manger/image_capture_manger.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_capture_manager_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source image_capture_manager_v1_0.tcl
