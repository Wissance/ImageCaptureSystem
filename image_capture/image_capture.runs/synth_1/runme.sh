...
HD_PWD='E:/oms/VideoControlIP/image_capture/image_capture.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_capture_manager.vds -m64 -mode batch -messageDb vivado.pb -notrace -source image_capture_manager.tcl
