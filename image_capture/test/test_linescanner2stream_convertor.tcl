...
add_force {/test_linescanner2stream_convertor/axi_aresetn} -radix hex {0} {1 100us} {0 970us} 
add_force {/test_linescanner2stream_convertor/axi_tready} -radix hex {0} {1 420us} {0 510us} {1 720us} 
